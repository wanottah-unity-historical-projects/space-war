...
public class Plantarium : MonoBehaviour
{
    ...
    // config
    bool NOSKIP = false;   // opt out of skip of every 2nd frame
    bool INTERLACED = false;   // Spacewar 2b - mode
    ...
    float HALFSCREEN = GameController.SCREEN_WIDTH / 2;
    int MAP_WIDTH = 8192;  // range of x-domain (0 .. 020000)

    // constructor, in original an assembler macro

    private void Magnitude(label)
    {
